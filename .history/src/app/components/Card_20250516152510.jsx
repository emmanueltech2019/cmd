...
const Card = ({
  ...
  return (
        <div className={`${optionalClass || 'border-4 border-white bg-web-cardbgcolor p-web-card rounded-web-cardradius'}border-4 border-white bg-web-cardbgcolor p-web-card rounded-web-cardradius`}>
