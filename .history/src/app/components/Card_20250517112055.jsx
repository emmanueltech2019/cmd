...
const Card = ({
  ...
  return (
        <div className={`${optionalClass || 'border-42 border-white bg-web-cardbgcolor p-web-card rounded-web-cardradius'}`}>
            <div className={`flex gap-3 border-[1px] border-[#FFFFFFCC] p-web-card rounded-web-cardradius flex-col items-start ${className}`} 
                style={{
            ...
            >
                ...
                <p className={`text-web-lightblue text-lg font-light`}>{description}</p>
            </div>
        </div>
