  ...
  return (
    <>
        <div className="h-screen w-full bg-[url('https://framerusercontent.com/images/b5PTKGzRyBS3L9UKBodiyhgwtrk.png?scale-down-to=2048')] bg-cover bg-center">
            ...
            <navbar className="w-web-navwidth mx-auto bg-web-navwhite backdrop-blur-md p-web-nav-padding flex justify-between items-center rounded-web-radius border-white border-3 my-5">
