    ...
    <>
        ...
        >
            <nav className='py-5'>
                <div className="w-web-navwidth mx-auto bg-web-navwhite backdrop-blur-md p-web-nav-padding flex justify-between items-center rounded-web-radius border-white border-3 my-5">
                    ...
                    <ul className="flex gap-web-navgap items-center text-navfontsize">
                        ...
                        <li>
                            <button className='p-web-nav-padding bg-transparent hover:bg-web-blue text-web-#180707 hover:text-white transition-all duration-500 rounded-web-navbtnradius'>Testimonials</button>
                        </li>
                        <li>
            ...
            <div className="mt-10 w-[100%] md:w-[70%] mx-auto">
                ...
                <p className='text-websubhero-font text-hero-navgray'>Attract More Patients, Get More Referrals, and Dominate Your Surgical Market</p>
            </div>
        </div>
    </>
  )
