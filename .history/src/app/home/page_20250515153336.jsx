  ...
  return (
    <>
        ...
        >
            ...
            <div className="padding-web-heroslideview bg-web-navwhite">Premium Positioning</div>
            <div className="padding-web-heroslideview bg-web-navwhite">Operational Efficiency</div>
            <div className="padding-web-heroslideview bg-web-navwhite">Higher Patient Volume</div>
        </div>
    </>
  )
}
