    ...
    <>
        ...
        >
            ...
            <div className="flex justify-center items-center gap-3">
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red border-3">Increased Referrals</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red border-3">Premium Positioning</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red border-3">Operational Efficiency</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red border-3">Higher Patient Volume</div>
            </div>
        </div>
    </>
  )
