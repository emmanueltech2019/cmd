    ...
    <>
        ...
        >
            ...
            <div className="flex justify-center items-center gap-3">
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red-500 border-2">Increased Referrals</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red-500 ">Premium Positioning</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red-500 ">Operational Efficiency</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-red-500 ">Higher Patient Volume</div>
            </div>
        </div>
    </>
  )
