    ...
    <>
        ...
        >
            ...
            <div className="flex justify-center items-center gap-3">
                <div className="padding-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-3">Increased Referrals</div>
                <div className="padding-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-3">Premium Positioning</div>
                <div className="padding-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-3">Operational Efficiency</div>
                <div className="padding-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-3">Higher Patient Volume</div>
            </div>
        </div>
    </>
  )
