    ...
    <>
        ...
        >
            ...
            <div className="flex justify-center items-center gap-3">
                <slideview className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-4">Increased Referrals</slideview>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-4">Premium Positioning</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-4">Operational Efficiency</div>
                <div className="p-web-heroslideview bg-web-navwhite flex justify-center items-center border-white border-4">Higher Patient Volume</div>
            </div>
        </div>
    </>
  )
