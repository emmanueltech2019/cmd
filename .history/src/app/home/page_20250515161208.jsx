            ...
            <div className="whitespace-nowrap">
                <SlideView>
                    <div className="flex gap-3">
                        <Image src={medellinCheck} alt='medellin check' width={100} height={100} />
                        Increased Referrals
                    </div>
                </SlideView>
                <SlideView>
                    <div className="flex gap-3">
                        <Image src={medellinCheck} alt='medellin check' width={100} height={100} />
                        Increased Referrals
                    </div>Premium Positioning</SlideView>
                <SlideView>Operational Efficiency</SlideView>
                <SlideView>Higher Patient Volume</SlideView>
            </div>
        </div>
    </>
  )
