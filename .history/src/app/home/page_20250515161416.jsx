            ...
            <div className="whitespace-nowrap">
                <SlideView>
                    <div className="flex gap-3">
                        <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-20' />
                        Increased Referrals
                    </div>
                </SlideView>
                <SlideView>
                    <div className="flex gap-3">
                        <Image className='w-20' src={medellinCheck} alt='medellin check' width={100} height={100} />
                        Premium Positioning
                    </div>
                </SlideView>
                <SlideView>
