...
const page = () => {
    const slideViewData = [
        { text: 'Increased Referrals', image: medellinCheck },
        { text: 'Premium Positioning', image: medellinCheck },
        { text: 'Operational Efficiency', image: medellinCheck },
        { text: 'Higher Patient Volume', image: medellinCheck },
    ];
  return (
    <>
        ...
        >
            ...
            <div className="whitespace-nowrap">
                ...
                <SlideView>
                    <div className="flex gap-3">
                        <Image className='w-5' src={medellinCheck} alt='medellin check' width={100} height={100} />
                        Premium Positioning
                    </div>
                </SlideView>
                <SlideView>
