    ...
    <>
        ...
        <div className="container grid grid-cols-3 gap-3 mx-auto my-5">
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="border-4 border-white p-web-card rounded-web-cardradius flex flex-column gap-3" 
                    style={{
            ...
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="border-4 border-white p-web-card rounded-web-cardradius flex flex-column gap-e" 
                    style={{
                        backgroundImage: `url(${medellinDotted.src})`,
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
