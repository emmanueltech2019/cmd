...
import medellinCircle from '@/images/gif/medellinCircle.gif'
            ...
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                ...
                >
                    <div className="p-3 rounded-full bg-web-blue relative">
                        <Image src={medellinCircle} alt='medellin circle' width={100} height={100} className='w-5 absolute' />
                        <Image src={medellinPatient} alt='medellin patient' width={100} height={100} className='w-5 absolute' />
                    </div>
                </div>
            </div>
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
