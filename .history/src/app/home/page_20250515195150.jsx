    ...
    <>
        ...
        <div className="container grid grid-cols-3 gap-3 mx-auto my-5">
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="flex gap-3 border-4 border-white p-web-card rounded-web-cardradius flex-col justify-start" 
                    style={{
                ...
                >
                    ...
                    <div className="text-lg text-web-blue font-semibold">Higher Patient Volume</div>
                </div>
            </div>
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
