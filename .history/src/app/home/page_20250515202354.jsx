...
import medellinReferal from '@/images/gif/medellinReferal.gif'
import medellinCircle from '@/images/gif/medellinCircle.png'
    ...
    <>
        ...
        <div className="container grid grid-cols-3 gap-3 mx-auto my-5">
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="flex gap-3 border-4 border-[#FFFFFFCC] p-web-card rounded-web-cardradius flex-col items-start" 
                    style={{
                ...
                >
                    <div className="p-[3] rounded-full border-web-blue border-[0.0000000001rem] relative">
                        <div className="p-3 rounded-full bg-web-blue relative">
                            ...
                            <Image src={medellinPatient} alt='medellin patient' width={100} height={100} className='w-8' />
                        </div>
                    </div>
                    <h4 className="text-lg text-web-blue font-medium">Higher Patient Volume</h4>
                    <p>Patients prefer the precision and faster recovery of robotic surgery. This translates into more appointments and procedures for their practice.</p>
                </div>
            </div>
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="flex gap-3 item-start border-4 border-[#FFFFFFCC] p-web-card rounded-web-cardradius flex-col" 
                    style={{
                        backgroundImage: `url(${medellinDotted.src})`,
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                ...
                >
                    <div className="p-[3] rounded-full border-web-blue border-[0.0000000001rem] relative">
                        <div className="p-3 rounded-full bg-web-blue relative">
                            <Image src={medellinCircle} alt='medellin circle' width={100} height={100} className='w-[90%] absolute left-[50%] top-[50%] animate-rotate' />
                            <Image src={medellinPremium} alt='medellin premium' width={100} height={100} className='w-8' />
                        </div>
                    </div>
                     <h4 className="text-lg text-web-blue font-medium">Increased Referrals</h4>
                    <p>Doctors who know your expertise in robotic surgery will refer more patients to you, expanding your network and your income.</p>
                </div>
            </div>
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="flex gap-3 border-4 border-[#FFFFFFCC] p-web-card rounded-web-cardradius flex-col" 
                    style={{
                        backgroundImage: `url(${medellinDotted.src})`,
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                ...
                >
                     <h4 className="text-lg text-web-blue font-medium">Premium Positioning</h4>
                    <p>Offering robotic surgery positions you as a leader in your field, allowing you to set more competitive rates and attract higher-value patients.</p>
                </div>
            </div>
        </div>
    </>
