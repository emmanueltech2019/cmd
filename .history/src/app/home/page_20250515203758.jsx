        ...
        <div className="w-full md:w-[80%] grid grid-cols-1 md:grid-cols-3 gap-3 mx-auto my-5">
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                ...
                >
                    ...
                    <p className={`text-[#858f9d] text-l`}>Patients prefer the precision and faster recovery of robotic surgery. This translates into more appointments and procedures for their practice.</p>
                </div>
            </div>
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                ...
                >
                    ...
                    <p className={`text-[#858f9d] text-l`}>Doctors who know your expertise in robotic surgery will refer more patients to you, expanding your network and your income.</p>
                </div>
            </div>
            <div className="border-4 border-white p-web-card rounded-web-cardradius">
                <div className="flex gap-3 border-4 border-[#FFFFFFCC] p-web-card rounded-web-cardradius flex-col items-start" 
                ...
                >
                    ...
                    <p className={`text-[#858f9d] text-l`}>Offering robotic surgery positions you as a leader in your field, allowing you to set more competitive rates and attract higher-value patients.</p>
                </div>
            </div>
        </div>
    </>
