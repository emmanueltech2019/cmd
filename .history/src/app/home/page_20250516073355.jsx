...
import SubCardWrapper from '../components/SubCardWrapper'
import GifCardWrapper from '../components/GifCardWrapper'
import SubGifCardWrapper from '../components/SubGifCardWrapper'
        ...
        <CardWrapper>
            <Card>
                <SubCardWrapper>
                    ...
                    <p className={`text-[#858f9d] text-lg font-lighter`}></p>
                </SubCardWrapper>
            </Card>
            <Card gifCircle={medellinCircle} gifImg={medellinPatient} title='Higher Patient Volume' description='Doctors who know your expertise in robotic surgery will refer more patients to you, expanding your network and your income.' />
