...
const page = () => {
  ...
  return (
    <>
            ...
            <nav className='py-5'>
                <div className="flex items-center justify-between mx-auto my-5 border-4 border-white w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
                    ...
                    <ul className="flex items-center gap-web-navgap text-navfontsize">
                        <li>
                            <NavButton className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Characteristics</NavButton>
                        </li>
                        <li>
                            <NavButton className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Prices</NavButton>
                        </li>
                        <li>
                            <NavButton className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Testimonials</NavButton>
                        </li>
                        <li>
                            <NavButton className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Questions</NavButton>
                        </li>
                    </ul>
                    <NavButton>Schedule a call now</NavButton>
                </div>
            </nav>
        ...
        <div className="w-full p-0 h-web-videoheight overflow-hidden flex justify-center items-center my-15">
        ...
        <div className="my-5 flex justify-center items-center w-full">
            <div className="w-full md:w-[50%]">
                <div className="w-full flex justify-center items-center">
                    <div className="border-white border-2 p-1 rounded-3xl">
                        <button className="bg-white text-web-blue p-2 rounded-3xl">
                            Get in touch
                        </button>
                    </div>
                </div>
