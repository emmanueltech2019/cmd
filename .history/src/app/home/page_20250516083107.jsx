    ...
    <>
        ...
        <div className="my-5 flex justify-center items-center w-full">
            <div className="w-full md:w-[50%]">
                ...
                <div className="my-10">
                    <form action="">
                        <label htmlFor="name" className='flex items-center justify-between mx-auto my-5 border-4 border-white w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius'>
                            <input type="text" placeholder='Red Walls' className='border-2 border-web-lightblue rounded-web-radius p-2 w-full' />
                        </label>
                    </form>
                </div>
            </div>
