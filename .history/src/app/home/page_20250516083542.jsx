                ...
                <div className="my-10">
                    <form action="">
                        <label htmlFor="name" className='text-web-blue text-xl'>
                            Name
                            <input type="text" placeholder='Red Walls' className='w-full text-sm flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-lg placeholder:text-web-lightblue border-white rounded-web-radius p-2 w-full' />
                        </label>
                    </form>
                </div>
            </div>
