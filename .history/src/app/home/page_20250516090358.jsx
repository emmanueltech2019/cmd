                ...
                <div className="my-10">
                    <form action="">
                        <label htmlFor="name" className='text-xl text-web-blue'>
                            Name
                            <input type="text" placeholder='Red Walls' className='w-full flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-formcolor backdrop-blur-md   placeholder:text-web-lightblue border-white rounded-xl p-2 ' />
                        </label>
                        <label htmlFor="name" className='text-xl text-web-blue'>
                            Name
                            <input type="text" placeholder='Red Walls' className='w-full flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-formcolor backdrop-blur-md   placeholder:text-web-lightblue border-white rounded-xl p-2' />
