                ...
                <div className="my-10">
                    <form action="">
                        ...
                        <label htmlFor="select" className='text-web-blue'>
                            Name
                            <select type="text" className='w-full flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-formcolor backdrop-blur-md  placeholder:text-web-lightblue rounded-xl p-2'><select/
                        </label>
                        <label htmlFor="name" className='text-web-blue'>
                            Name
