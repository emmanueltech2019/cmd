                ...
                <div className="my-10">
                    <form action="">
                        ...
                        <label htmlFor="briefly" className='text-web-blue'>
                            ...
                            <textarea type="text" placeholder='' className='w-full flex items-center justify-between mx-auto my-2 border-[1px] bg-web-formcolor backdrop-blur-md placeholder:text-web-lightblue border-white rounded-xl p-2' />
                        </label>
                    </form>
                </div>
            </div>
