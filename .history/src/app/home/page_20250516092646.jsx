                ...
                <div className="my-10">
                    <form action="">
                        ...
                        <label htmlFor="briefly" className='text-web-blue'>
                            Briefly share what you are most looking orward to in your practice 
                            <textarea type="text" placeholder='What I most desire for my practice is...' className='w-full flex items-center justify-between mx-auto my-2 border-[1px] bg-web-formcolor backdrop-blur-md placeholder:text-web-lightblue border-white rounded-xl p-2' row />
                        </label>
                    </form>
                </div>
            </div>
