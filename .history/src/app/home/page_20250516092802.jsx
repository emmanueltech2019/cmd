    ...
    <>
        ...
        <div className="flex items-center justify-center w-full my-5">
            <div className="w-full md:w-[50%]">
                ...
                <div className="my-10">
                    <form action="">
                        <label htmlFor="name" className='text-web-blue my-5'>
                            Name
                        ...
                        <label htmlFor="email" className='text-web-blue my-5'>
                            Email
                        ...
                        <label htmlFor="select" className='text-web-blue my-5'>
                            Select
                        ...
                        <label htmlFor="briefly" className='text-web-blue my-5'>
