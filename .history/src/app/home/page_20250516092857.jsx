    ...
    <>
        ...
        <div className="flex items-center justify-center w-full my-5">
            <div className="w-full md:w-[50%]">
                ...
                <div className="my-10">
                    <form action="">
                        <label htmlFor="name" className='my-20 text-web-blue'>
                            Name
                        ...
                        <label htmlFor="email" className='my-20 text-web-blue'>
                            Email
                        ...
                        <label htmlFor="select" className='my-20 text-web-blue'>
                            Select
                        ...
                        <label htmlFor="briefly" className='my-20 text-web-blue'>
