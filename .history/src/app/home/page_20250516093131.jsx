    ...
    <>
        ...
        <div className="flex items-center justify-center w-full my-5">
            <div className="w-full md:w-[50%]">
                ...
                <div className="my-10">
                    <form action="">
                        <label htmlFor="name" className='py-20 text-web-blue'>
                            Name
                        ...
                        <label htmlFor="email" className='py-20 text-web-blue'>
                            Email
                        ...
                        <label htmlFor="select" className='py-20 text-web-blue'>
                            Select
                        ...
                        <label htmlFor="briefly" className='py-20 text-web-blue'>
