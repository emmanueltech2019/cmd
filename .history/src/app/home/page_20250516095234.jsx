    ...
    <>
        ...
        <div className="my-10">
            <div className="flex flex-col items-center justify-center">
                ...
                <h1 className="text-center text-web-blue text-web-contactformfont">Our Packages to Boost Your Robotics Practice</h1>
                <p className="text-web-lightblue text-center">We offer comprehensive solutions to help you capitalize on the financial benefits of robotic surgery.</p>
            </div>
        </div>
    </>
  )
