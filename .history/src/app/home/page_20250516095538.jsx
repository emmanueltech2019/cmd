    ...
    <>
        ...
        <div className="my-10">
            <div className="flex flex-col items-center justify-center md:w-[50%] w-full mx-auto">
                ...
                <p className="text-center px-20text-lg text-web-lightblue">We offer comprehensive solutions to help you capitalize on the financial benefits of robotic surgery.</p>
            </div>
        </div>
    </>
  )
