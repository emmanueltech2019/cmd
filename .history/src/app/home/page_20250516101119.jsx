...
const page = () => {
  ...
  return (
    <>
        ...
        >
            <nav className='fixed left-0 w-full py-5 top-10'>
                <div className="flex items-center justify-between mx-auto border-4 border-white w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
