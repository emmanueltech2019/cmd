...
const page = () => {
  ...
  return (
    <>
        <div className={`h-screen w-full flex flex-`} 
            style={{
        ...
        >
            <nav className='w-full py-5'>
                <div className="fixed top-0 flex items-center justify-between mx-auto my-5 border-4 border-white w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
        ...
        <div className="my-10">
            ...
            <div className="my-20 md:w-[50%] w-full" style={{
