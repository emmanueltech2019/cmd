    ...
    <>
        ...
        >
            <nav className='w-full py-5'>
                <div className="fixed top-0 flex items-center justify-between mx-auto my-5 border-4 border-white translate-x-2/1 left-1/2 w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
