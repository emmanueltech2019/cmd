    ...
    <>
        ...
        <div className="my-10">
            ...
            <div className="my-20 md:w-[80%] w-full p-10 mx-auto rounded-3xl" style={{
                ...
                <SecondCard gifCircle={medellinCircle} gifImg={medellinStrategy} title='SEO Strategy' description='Generate doctor-to-doctor referals with branded campaigns targeting your colleagues.' />
            </div>
        </div>
    </>
  )
