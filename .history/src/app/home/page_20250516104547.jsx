    ...
    <>
        ...
        <div className="my-10">
            ...
            <div className="my-20 md:w-[80%] w-full p-10 mx-auto rounded-3xl" style={{
                ...
                <SecondCard gifCircle={medellinCircle} gifImg={medellinReputation} title="Managing Your Pr'" description='Boost your authority with 10 custom content pieces that build trust.' />
            </div>
        </div>
    </>
  )
