    ...
    <>
        ...
        <div className="my-10">
            ...
            <div className="my-20 md:w-[80%] w-full p-10 mx-auto rounded-3xl" style={{
                ...
                <SecondCard gifCircle={medellinCircle} gifImg={medellinRevenue} title="Increase Your Practice's Revenue" description='Optimize your processes, reduce absences, and improve loyalty to achieve a sta' />
            </div>
        </div>
    </>
  )
