...
const page = () => {
  ...
  return (
    <>
        <nav className="fixed top-0 flex items-center justify-between mx-auto my-5 -translate-x-1/2 border-4 border-white z-60 left-1/2 w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
            <div >
        ...
        <div className="my-10">
            ...
            <div className="my-20 md:w-[80%] w-full p-10 mx-auto rounded-3xl" style={{
                ...
                <SecondCard gifCircle={medellinCircle} gifImg={medellinRevenue} title="Increase Your Practice's Revenue" description='Optimize your processes, reduce absences, and improve loyalty to achieve a steady stream of revenue.' />
            </div>
        </div>
    </>
  )
