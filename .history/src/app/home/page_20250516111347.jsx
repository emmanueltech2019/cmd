    ...
    <>
        ...
        <div className="my-10">
            ...
            <CardWrapper bg={`${secondCardBackground.src}`} className={`border-4 border-white rounded-3xl p-10`}>
                <SecondCard className={`bg-web-`} gifCircle={medellinCircle} gifImg={medellinGlobe} title='High Converting Website' description='Build a direct-to-patient funnel through an optimized landing page to convert visitors into booked appointments.' />
                <SecondCard className={`bg-web-`} gifCircle={medellinCircle} gifImg={medellinAudience} title='Brand Audience' description='Generate doctor-to-doctor referals with branded campaigns targeting your colleagues.' />
                <SecondCard className={`bg-web-`} gifCircle={medellinCircle} gifImg={medellinStrategy} title='SEO Strategy' description='Win searches with rich SEO language and dominate local results.' />
                <SecondCard className={`bg-web-`} gifCircle={medellinCircle} gifImg={medellinContent} title='Content' description='Boost your authority with 10 custom content pieces that build trust.' />
                <SecondCard className={`bg-web-`} gifCircle={medellinCircle} gifImg={medellinReputation} title="Managing Your Practice's Reputation" description='Respond to reviews, improve your digital presence, and turn positive experiences into growth for your practice.' />
                <SecondCard className={`bg-web-`} gifCircle={medellinCircle} gifImg={medellinRevenue} title="Increase Your Practice's Revenue" description='Optimize your processes, reduce absences, and improve loyalty to achieve a steady stream of revenue.' />
            </CardWrapper>
        </div>
    </>
  )
