  ...
  return (
    <>
        ...
        <CardWrapper className={`md:grid-cols-2`} bg={`${secondCardBackground.src}`}> 
            ...
            <FiftyPercentDefaultWrapper textClass={``} className={`w-full items-start`} outlineText={`Join the top 10`} title={`Revenue and Reputation with Advanced Robotic Surgery`} description={`take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is booming, and patients are actively seeking surgeons who offer this cutting-edge technology.`} />
        </CardWrapper>
    </>
  )
}
