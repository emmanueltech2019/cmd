  ...
  return (
    <>
        ...
        <CardWrapper className={`md:grid-cols-2`} bg={`${secondCardBackground.src}`}> 
            ...
            <FiftyPercentDefaultWrapper textClass={`text-start px-5`} className={`md:w-full items-start`} outlineText={`Join the top 10`} title={`Revenue and Reputation with Advanced Robotic Surgery`} description={`Are you looking to take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is boom`} />
        </CardWrapper>
    </>
  )
}
