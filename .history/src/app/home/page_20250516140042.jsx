  ...
  return (
    <>
        ...
        <CardWrapper className={`md:grid-cols-2`} bg={`${secondCardBackground.src}`}> 
            ...
            <FiftyPercentDefaultWrapper textClass={`text-start px-5`} extraClass='pe' className="items-start justify-start md:w-full" outlineText={`Join the top 10`} title={`Increase Your Revenue and Reputation with Advanced Robotic Surgery`} description={`Are you looking to take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is booming, and patients are actively seeking surgeons who offer this cutting-edge technology.`} infiniteSlider={<InfiniteSlider className={`md:w-[80%] mt-5 mr-auto`} />} />
        </CardWrapper>
    </>
  )
}
