...
const page = () => {
  return (
    <>
        ...
        <div className="my-10">
            <FiftyPercentDefaultWrapper outlineText='Get in ouch' title='Our Packages to Boost Your Robotics Practice' description="'We offer comprehensive solutions to help you capitalize on the financial benefits of robotic surgery." inlineClass='md:w-[70%]' />
