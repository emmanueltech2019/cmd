  ...
  return (
    <>
        ...
        <CardWrapper className={`md:grid-cols-2 p-20 border-white border-2 rounded-3xl`} bg={`${secondCardBackground.src}`}> 
            ...
            <FiftyPercentDefaultWrapper textClass={`text-start px-5`} extraClass='mx-5 text-sm' className="flex flex-col items-start justify-start mb-10 md:w-full" outlineText={`Join the 10`} title={`Increase your surgical volume and attract high-value patients to your schedule.`} description={`Are you looking to take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is booming, and patients are actively seeking surgeons who offer this cutting-edge technology.`} infiniteSlider={<InfiniteSlider className={`md:w-[80%] mt-5 mr-auto`} />} />
