...
const page = () => {
  return (
    <>
        ...
        <div className="my-20">
            <FiftyPercentDefaultWrapper outlineText='Economical for your office' title='Gain the competitive advantage your practice needs' description="'Stand out in health care sector with innovative solutions that improve efficiency, attract more patients, and strengthen your practice's reputation. Take your practice to the next level with tools designed to make difference." inlineClass='md:w-[70%]' />
        </div>
    </>
  )
}
