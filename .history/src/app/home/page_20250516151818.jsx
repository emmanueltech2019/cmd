...
const page = () => {
  return (
    <>
        ...
        <div className="my-20">
            <FiftyPercentDefaultWrapper outlineText='Economical for your office' title='Our Pricing Plans' description="Discover our adaptable pricing options tailored to meet your financial and educational requirements." inlineClass='md:w-[70%] my-5' />
        </div>
    </>
  )
}
