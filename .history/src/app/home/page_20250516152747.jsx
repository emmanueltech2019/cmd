    ...
    <>
        ...
        <div className="my-10">
            ...
            <CardWrapper bg={`${secondCardBackground.src}`} className={`border-4 border-white rounded-3xl p-10`}>
                <Card optionalClass={} className={`bg-web-cardbgcolor`} gifCircle={medellinCircle} gifImg={medellinGlobe} title='High Converting Website' description='Build a direct-to-patient funnel through an optimized landing page to convert visitors into booked appointments.' />
                <Card optionalClass={} className={`bg-web-cardbgcolor`} gifCircle={medellinCircle} gifImg={medellinAudience} title='Brand Audience' description='Generate doctor-to-doctor referals with branded campaigns targeting your colleagues.' />
                <Card optionalClass={} className={`bg-web-cardbgcolor`} gifCircle={medellinCircle} gifImg={medellinStrategy} title='SEO Strategy' description='Win searches with rich SEO language and dominate local results.' />
                <Card optionalClass={} className={`bg-web-cardbgcolor`} gifCircle={medellinCircle} gifImg={medellinContent} title='Content' description='Boost your authority with 10 custom content pieces that build trust.' />
                <Card optionalClass={} className={`bg-web-cardbgcolor`} gifCircle={medellinCircle} gifImg={medellinReputation} title="Managing Your Practice's Reputation" description='Respond to reviews, improve your digital presence, and turn positive experiences into growth for your practice.' />
                <Card optionalClass={} className={`bg-web-cardbgcolor`} gifCircle={medellinCircle} gifImg={medellinRevenue} title="Increase Your Practice's Revenue" description='Optimize your processes, reduce absences, and improve loyalty to achieve a steady stream of revenue.' />
            </CardWrapper>
        </div>
        ...
        <CardWrapper className={`md:grid-cols-2 p-20 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}> 
