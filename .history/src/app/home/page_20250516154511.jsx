  ...
  return (
    <>
        ...
        <div className="my-20">
            ...
            <CardWrapper className={`md:grid-cols-2 p-20 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}>
                <Card gifImg={medellinPatient} title='Higher Patient Volume' description='Patients prefer the precision and faster recovery of robotic surgery. This translates into more appointments and procedures for their practice.' />
            </CardWrapper>
        </div>
    </>
  )
