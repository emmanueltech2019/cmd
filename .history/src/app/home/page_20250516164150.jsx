...
const page = () => {
  return (
    <>
        ...
        <CardWrapper gridCol={`grid-cols-2`} className={`md:grid-cols-2 p-20 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}> 
        ...
        <CardWrapper gridCol={`grid-cols-2`}>
