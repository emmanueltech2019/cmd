    ...
    <>
        ...
        <CardWrapper gridCol={`grid-cols-2`} className={`p-10 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}>
            ...
            <div className="w-full md:w-[80%] p-10">
                <FiftyPercentDefaultWrapper outlineText='Testimonials' title='Listen to the best surgeons' description='Discover how leading surgeons have grown their practices and increased their revenue by fully embracing robotic surgery.' inlineClass='my-' />
            </div>
        </CardWrapper>
    </>
  )
