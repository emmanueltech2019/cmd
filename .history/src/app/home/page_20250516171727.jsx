  ...
  return (
    <>
        ...
        <div className="w-full md:w-[80%] p-10 mx-auto">
            <FiftyPercentDefaultWrapper outlineText='Testimonials' title='Listen to the best surgeons' description='Discover how leading surgeons have grown their practices and increased their revenue by fully embracing robotic surgery.' inlineClass='py-20' inlineClass />
