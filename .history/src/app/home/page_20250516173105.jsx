...
const page = () => {
  return (
    <>
        ...
        <div className="w-full md:w-[80%] p-10 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">    
                <div className="p-3 border-2 border-white rounded-2xl bg-web-cardbgcolor">
                    <div className="flex flex-col gap-2 p-2">
                        <div className="flex items-center gap-2 py-2 border-b border-web-cardbgcolor border-2">
                            <Image src={Nicholas} alt='Nicholas' width={100} height={100} className='rounded-xl w-[20%]' />
                            <div className="flex flex-col gap-2">
                                <h5 className='text-lg'>Nicholas Barcellona</h5>
                                <p className="font-lighter">CFO, WVU Medicine</p>
                            </div>
                        </div>
                        <p className="text-sm">
                            "Each robotic surgery case generates 16% more revenue than traditional surgery. We've also observed a 51% reduction in hospital stays compared to open surgery."
                        </p>
                    </div>
                </div>
                <div className="p-3 border-2 border-white rounded-2xl bg-web-cardbgcolor">
                    <div className="flex flex-col gap-2 p-2">
                        <div className="flex items-center gap-2 py-2 border-b border-web-cardbgcolor">
                            <Image src={Nicholas} alt='Nicholas' width={100} height={100} className='rounded-xl w-[10%]' />
                            <div className="flex flex-col gap-2">
                                <h5 className='text-lg'>Nicholas Barcellona</h5>
                                <p className="font-lighter">CFO, WVU Medicine</p>
                            </div>
