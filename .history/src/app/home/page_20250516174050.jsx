...
const page = () => {
    const people = [
        ...
        },
        {
            ...
            description: "By converting open vertral hernia causes to robotic surgery, we could more than double our profits. Even by converting just 50%, we could add about "
        }
        {
            name: 'Nicholas',
            occupation: 'CFO, WVU Medicine',
