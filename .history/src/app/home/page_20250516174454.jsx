...
const page = () => {
    const people = [
        ...
        },
        {
            ...
            description: "With the da Vinci 5, I can perform a hysterectomy in 20 to 25 minutes, instead of over an hour. That efficiency translates into better patient outcomes and more scheduled procedure "
        }
    ]
  return (
    <>
