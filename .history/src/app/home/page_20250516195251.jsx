...
const page = () => {
  ...
  return (
    <>
        ...
        >
            <FiftyPercentDefaultWrapper outlineText='FAQs' title='Listen to the best surgeons' description='Discover how leading surgeons have grown their practices and increased their revenue by fully embracing robotic surgery.' inlineClass='py-20 md:w-[70%]' />
            <div className="grid items-start grid-cols-1 gap-3 md:grid-cols-3" >    
