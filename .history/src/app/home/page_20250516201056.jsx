        ...
        >
            ...
            <div className="flex flex-col gap-3" > 
                <div className="relative bg-[rgba(255,255,255,0.3)]">
                    ...
                    <div className="p-3">
                        <p>Robotic surgery improves surgical precision, reduces recovery times, and minimizes complications, making it highly attractive to patients. As demand for minimally invasive produr</p>
                    </div>
                </div>   
            </div>
        </div>
