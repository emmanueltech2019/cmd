  ...
  return (
    <>
        ...
        >
            ...
            <div className="flex flex-col gap-3" > 
                <div className="relative bg-[rgba(255,255,255,0.3)] rounded-xl">
                    <div className="flex items-center justify-between px-3 py-1 text-xl bg-white text-web-blue rounded-xl">
                        How can robotic surgery increase my surgical volume and revenue?
                        <Image src={accordionArrow} alt='accordion arrow' width={100} height={100} className='w-[2%]' />
                    </div>
