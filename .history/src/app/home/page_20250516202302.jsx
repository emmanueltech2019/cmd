...
const page = () => {
    ...
    const accordionContent = [ 
        ...
        },
        {
            ...
            content: 'Complex procedures such as prostatectomies, hysterectomies, colorectal resections, hernia repairs, and bariatric surgeries tend to generate higher revenues when performed with robotic assistance. These cases benefit significantly from the precsion an',
            arrow: accordionArrow
        },
        {
            header: 'How can robotic surgery increase my surgical volume and revenue?',
  ...
  return (
    <>
        ...
        >
            ...
            <div className="flex flex-col gap-3" > 
                <div className="relative bg-[rgba(255,255,255,0.3)] rounded-xl cursor-pointer">
                    <div className="flex items-center justify-between px-3 py-2 text-xl bg-white text-web-blue rounded-xl">
                        How can robotic surgery increase my surgical volume and revenue?
                        <Image src={accordionArrow} alt='accordion arrow' width={100} height={100} className='w-[3%]' />
                    </div>
                    <div className="p-5 text-lg text-web-lightblue">
                        <p>Robotic surgery improves surgical precision, reduces recovery times, and minimizes complications, making it highly attractive to patients. As demand for minimally invasive procedures grows, surgeons who offer robotic options oftern receive more referrals, increase their patient volume, and reduce operating time. This efficiency allows for more procedures to be scheduled per week and improves financial perfomance per case, especially in complex surgeries that typically have higher reimbursement rates.</p>
                    </div>
                </div>   
            </div>
        </div>
