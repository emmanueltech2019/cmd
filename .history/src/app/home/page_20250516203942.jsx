        ...
        >
            ...
            <div className="flex flex-col gap-3" >
                {accordionContent.map((content, index) => (    
                    <div onClick={() => setAccordion(!accordion)} className="relative bg-[rgba(255,255,255,0.3)] rounded-xl cursor-pointer">
                        ...
                        <div className={`h-0 p-0 overflow-hidden text-lg text-web-lightblue ${accordion ? 'h-'}`}>
                            <p>{content.content}</p>
                        </div>
                    </div>   
                ))} 
