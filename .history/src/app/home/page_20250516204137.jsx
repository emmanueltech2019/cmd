        ...
        >
            ...
            <div className="flex flex-col gap-3" >
                {accordionContent.map((content, index) => (    
                    <div key={index} onClick={() => setAccordion(!accordion)} className="relative bg-[rgba(255,255,255,0.3)] rounded-xl cursor-pointer">
                        ...
                        <div className={`p-5 grid grid-rows-0 overflow-hidden text-lg text-web-lightblue`}>
                            <p>{content.content}</p>
                        </div>
                    </div>   
                ))} 
