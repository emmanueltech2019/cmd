        ...
        >
            <div className="flex justify-between p-10 border-4 border-white bg-web-navwhite rounded-3xl">
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in General </button>
                </div>
            </div>
        </footer>
    </>
