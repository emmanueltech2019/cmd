...
const page = () => {
  ...
  return (
    <>
        ...
        <CardWrapper gridCol={`grid-cols-2`} className={`p-10 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}>
        ...
        <div className="w-full md:w-[80%] p-10 mx-auto border-white border-2 rounded-3xl mt-20 mb-20" 
            style={{
                backgroundImage: `url(${secondCardBackground.src})`
            }}
        >
            <FiftyPercentDefaultWrapper outlineText='Testimonials' title='Listen to the best surgeons' description='Discover how leading surgeons have grown their practices and increased their revenue by fully embracing robotic surgery.' inlineClass='py-20 md:w-[70%]' />
                            ...
                            <div  className="flex flex-col gap-2 p-2">
                                <div className="flex items-center gap-2 py-2 border-gray-300 border-b-[.1px]">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <p className="font-lighter">{bio.occupation}</p>
                                    </div>
                                </div>
                                <p className="text-sm">
                                    {bio.description}
        ...
        >
            <FiftyPercentDefaultWrapper outlineText='FAQs' title='Frequently Asked Questions' description='Growing Your Practice with Robotic Surgery' inlineClass='py-20 md:w-[70%]' />
            <div className="flex flex-col gap-3">
                {accordionContent.map((content, index) => {
                    ...
                    >
                        <div className="flex items-center justify-between px-3 py-2 text-xl bg-white text-web-blue rounded-xl">
                        {content.header}
                        <Image
                            src={content.arrow}
                            alt="accordion arrow"
                        ...
                        <div
                        ref={contentRef}
                        className="grid grid-cols-0 overflow-hidden transition-[max-height] duration-500 ease-in-out"
                        style={{
                            maxHeight: isOpen ? `${contentRef.current?.scrollHeight}px` : '0px',
                        }}
                        >
                        <div className="p-5 text-lg text-web-lightblue">
                            <p>{content.content}</p>
                        </div>
                        </div>
                    </div>
        ...
        >
            <div className="flex justify-between p-10 border-4 border-white bg-web-navwhite rounded-3xl">
                <div className="flex flex-col gap-10">
                    <Image className='w-[20%]' src={medellinLogo} width={700} height={700} alt="medellin logo" />
                    <div>
                        <p>Step into the surgery of the future! Contact us today and discover how to increase your revenue with robotic surgery.</p>
                        <NavButton className={`p-web-nav-padding w-full`}>
                            Get started now
                        </NavButton>
                    </div>
                </div>
                <div className="flex flex-col items-start justify-between flex-shrink-0">
                    <p className="text-web-blue">Robotic Surgery</p>
                    <button className='transition-all duration-500 bg-#46393900 p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in Colombia</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Minimally Invasive Surgery</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Benefits of Robotic Surgery</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Advances in Robotic Surgery</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Technology in Medicine</button>
                </div>
                <div className="flex flex-col items-start justify-between flex-shrink-0">
                    <p className="text-web-blue">General Surgery</p>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Cholecystectomy</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Hernia Surgery</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robot-Assisted Bowel Resection</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in General Surgery</button>
                    <button className='transition-all duration-500 bg-transparent p-web-nav-padding hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in Meddellin</button>
                </div>
            </div>
        </footer>
    </>
