        ...
        >
            <div className="flex justify-between p-10 border-4 border-white bg-web-navwhite rounded-3xl">
                ...
                <div className="flex flex-col items-start justify-between flex-shrink-0">
                    ...
                    <button className='transition-all duration-500 bg-#46393900 hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in Colombia</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Minimally Invasive Surgery</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Benefits of Robotic Surgery</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Advances in Robotic Surgery</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Technology in Medicine</button>
                </div>
                <div className="flex flex-col items-start justify-between flex-shrink-0">
                    <p className="text-web-blue">General Surgery</p>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Cholecystectomy</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Hernia Surgery</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robot-Assisted Bowel Resection</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in General Surgery</button>
                    <button className='transition-all duration-500 bg-transparent hover:bg-web-blue text-web-navgray hover:text-white rounded-web-navbtnradius'>Robotic Surgery in Meddellin</button>
                </div>
            </div>
        </footer>
    </>
