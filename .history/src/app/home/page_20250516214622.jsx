...
const page = () => {
  ...
  return (
    <>
        ...
        >
            <div className="flex gap-10 p-10 border-4 border-white bg-web-navwhite rounded-3xl">
                <div className="flex flex-col justify-between">
                    <Image className='w-[30%]' src={medellinLogo} width={700} height={700} alt="medellin logo" />
                    <div>
