...
const page = () => {
  ...
  return (
    <>
        ...
        <nav className="fixed top-0 z-50 items-ceter justify-between mx-auto my-5 -translate-x-1/2 border-4 border-white flex-coll left-1/2 w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
            <div className="flex items-center justify-center w-web-logowidth h-web-logoheight">
                <Image src={medellinLogo} width={100} height={100} alt='medellin logo' className='w-full' />
            </div>
            <ul className="flex items-center gap-web-navgap text-navfontsize">
