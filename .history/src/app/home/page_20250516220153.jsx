...
const page = () => {
  ...
  return (
    <>
        <nav className="fixed relative top-0 z-50 flex-col items-center justify-between mx-auto my-5 -translate-x-1/2 border-4 border-white left-1/2 w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius">
            ...
            <ul className="flex flex-col items-center gap-web-navgap text-navfontsize">
                <li>
            ...
            <p className='absolute right-0 top-1/2 -translate-1/2'>toggle</p>
        </nav>
