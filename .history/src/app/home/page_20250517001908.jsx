...
const page = () => {
  ...
  return (
    <>
        <nav className={`fixed top-0 z-50 flex-col items-center justify-between mx-auto my-5 -translate-x-1/2 border-4 border-white left-1/2 w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius ${toggleNav ? 'rounded-xl'}`}>
