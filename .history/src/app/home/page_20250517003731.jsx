  ...
  return (
    <>
        <nav className={`fixed top-0 z-50 flex-col items-center transition-rounded duration-500 ease-in-out justify-between mx-auto my-5 -translate-x-1/2 border-4 border-white left-1/2 w-web-navwidth bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius ${toggleNav ? 'rounded-xl' : 'rounded-web-radius'}`}>
            ...
            <ul ref={mobileNav} className="flex flex-co md:flex-row items-center overflow-hidden gap-web-navgap text-navfontsize transition-[max-height] duration-500 ease-in-out"
                style={{
