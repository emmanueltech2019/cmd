  ...
  return (
    <>
        <nav className={`fixed top-0 z-50 flex h-auto flex-col md:flex-row items-start md:items-center transition-rounded duration-500 ease-in-out justify-between mx-auto my-5 -translate-x-1/2 border-4 border-white left-1/2 md:w-web-navwidth w-full bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius ${toggleNav ? 'rounded-xl' : 'rounded-web-radius'}`}>
            ...
            <ul ref={mobileNav} className="flex flex-col md:flex-row items-center bg-red- overflow-hidden gap-web-navgap text-navfontsize transition-[max-height] duration-500 ease-in-out"
                style={
                    isMobile ? {
