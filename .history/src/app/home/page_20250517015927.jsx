...
const page = () => {
  ...
  return (
    <>
        ...
        >
            <div className="mt-10 w-[100%] md:w-[70%] mx-auto md:px-0 px-3">
                ...
                <p className='py-5 text-xl text-center md:text-websubhero-font text-web-navgray'>Attract More Patients, Get More Referrals, and Dominate Your Surgical Market</p>
            </div>
            <InfiniteSlider />
        ...
        <CardWrapper gridCol={`md:grid-cols-2`} className={`p-20 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}> 
            <div className="w-full">   
                <Image className='w-full' src={medellinDoctor} width={1000} height={1000} alt='medellin doctor' />
            </div>
            <FiftyPercentDefaultWrapper textClass={`text-start px-5`} extraClass='mx-5 text-sm' className="flex flex-col items-center justify-start w-full mb-10 md:items-start md:w-full" outlineText={`Join the top 10`} title={`Increase Your Revenue and Reputation with Advanced Robotic Surgery`} description={`Are you looking to take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is booming, and patients are actively seeking surgeons who offer this cutting-edge technology.`} infiniteSlider={<InfiniteSlider className={`md:w-[80%] mt-5 mr-auto`} />} />
        ...
        >
            <div className="flex flex-col gap-10 p-10 border-4 border-white md:flex-row bg-web-default rounded-3xl">
                <div className="flex flex-col justify-between">
                    <Image className='w-[50%]' src={medellinLogo} width={700} height={700} alt="medellin logo" />
                    <div>
                        <p className='mb-3 text-xl'>Step into the surgery of the future! Contact us today and discover how to increase your revenue with robotic surgery.</p>
