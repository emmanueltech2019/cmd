...
const page = () => {
  ...
  return (
    <>
        ...
        <CardWrapper gridCol={`md:grid-cols-2`} className={`p-10 border-white border-2 rounded-3xl mt-20 mb-20`} bg={`${secondCardBackground.src}`}>
        ...
        <div className="w-full md:w-[80%] md:p-10 p-5 mx-auto border-white border-2 rounded-3xl mt-20 mb-20" 
            style={{
                backgroundImage: `url(${secondCardBackground.src})`
            }}
        >
            <FiftyPercentDefaultWrapper outlineText='Testimonials' title='Listen to the best surgeons' description='Discover how leading surgeons have grown their practices and increased their revenue by fully embracing robotic surgery.' inlineClass='md:py-20  md:w-[70%]' />
