...
const page = () => {
  ...
  return (
    <>
        ...
        >
            <FiftyPercentDefaultWrapper outlineText='FAQs' title='Frequently Asked Questions' description='Growing Your Practice with Robotic Surgery' inlineClass='md:py-20 md:w-[70%]' />
            <div className="flex flex-col gap-3">
