  ...
  return (
    <>
        ...
        <div className="my-10">
            ...
            <CardWrapper bg={`${secondCardBackground.src}`} className={`md:grid-cols-2 border-4 border-white rounded-3xl p-5 mx-3`}>
        ...
        <CardWrapper gridCol={`md:grid-cols-2`} className={`md:p-20 p-5 border-white border-2 rounded-3xl mt-20 mb-20 mx-3`} bg={`${secondCardBackground.src}`}> 
        ...
        <CardWrapper gridCol={`md:grid-cols-2`} className={`p-10 border-white border-2 rounded-3xl mt-20 mb-20 mx-3`} bg={`${secondCardBackground.src}`}>
            ...
            <div className="flex flex-col gap-3">
                {accordionContent.map((content, index) => {
                    ...
                    >
                        ...
                        >
                        <div className="p-5 text-sm md:text-lg text-web-lightblue">
                            <p>{content.content}</p>
                        </div>
                        </div>
                    </div>
