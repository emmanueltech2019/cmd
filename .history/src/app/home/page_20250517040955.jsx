...
const page = () => {
  ...
  return (
    <>
        ...
        <AnimateOnScroll ref={sectionRef4} offset={20}></AnimateOnScroll>
        <AnimateOnScroll ref={sectionRef5} offset={20}></AnimateOnScroll>
        <AnimateOnScroll ref={sectionRef6} offset={20}></AnimateOnScroll>
        <AnimateOnScroll ref={sectionRef7} offset={20}></AnimateOnScroll>
        <AnimateOnScroll ref={sectionRef8} offset={20}></AnimateOnScroll>
        <AnimateOnScroll ref={sectionRef9} offset={20}></AnimateOnScroll>
        <div className="my-10">
