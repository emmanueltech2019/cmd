                    ...
                    <div className="my-10">
                        <form action="" className='px-3 md:px-0'>
                            <label htmlFor="name" className='text-web-blue'>
                                ...
                                <input id='name' type="text" placeholder='Red Walls' className='border-0 outline-0w-full flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-formcolor backdrop-blur-md  placeholder:text-web-lightblue rounded-xl p-2 ' />
                            </label>
                            <label htmlFor="email" className='text-web-blue'>
                                <div className="mt-3 md:mt-5">
                                    Email
                                </div>
                                <input id='email' type="text" placeholder='rojasparedes@correomd.com' className='border-0 outline-0w-full flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-formcolor backdrop-blur-md  placeholder:text-web-lightblue rounded-xl p-2' />
                            </label>
                            <label htmlFor="select" className='text-web-blue'>
                                <div className="mt-3 md:mt-5">
                                    Select
                                </div>
                                <select type="text" className='border-0 outline-0w-full flex items-center justify-between mx-auto my-2 border-[1px] border-white bg-web-formcolor backdrop-blur-md  placeholder:text-web-lightblue rounded-xl p-2'>
                            ...
                            <label htmlFor="briefly" className='text-web-blue'>
                                ...
                                <textarea type="text" placeholder='What I most desire for my practice is...' className='border-0 outline-0w-full flex items-center justify-between mx-auto my-2 border-[1px] bg-web-formcolor backdrop-blur-md placeholder:text-web-lightblue border-white rounded-xl p-2' rows={4} />
                            </label>
