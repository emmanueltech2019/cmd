    ...
    <>
        ...
        >
            <div className="md:mt-[19%] mt-[50%] w-[100%] md:w-[80%] mx-auto md:px-0 px-3 animate-translate">
                <h1 className="px-5 text-4xl text-center text-web-blue md:text-webhero-font md:leading-webhero-lineheight">Transform Your Surgical Practice! Maximize Profits with Robotic Surgery in Medellin</h1>
