  ...
  return (
    <>
        ...
        <AnimateOnScroll ref={sectionRef6} offset={20}>     
            <CardWrapper gridCol={`md:grid-cols-2`} className={`md:p-20 p-5 border-white border-2 rounded-3xl mt-20 mb-20 mx-auto`} bg={`${secondCardBackground.src}`}> 
                <div className="w-full">   
                    <Image className='w-full' src={medellinDoctor} width={1000} height={1000} alt='medellin doctor' />
                </div>
                <FiftyPercentDefaultWrapper textClass={`md:text-start `} extraClass='mx-5 text-sm' className="flex flex-col items-center justify-start w-full mb-10 md:items-start md:w-full" outlineText={`Join the top 10`} title={`Increase Your Revenue and Reputation with Advanced Robotic Surgery`} description={`Are you looking to take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is booming, and patients are actively seeking surgeons who offer this cutting-edge technology.`} infiniteSlider={<InfiniteSlider className={`md:w-[80%] mt-5 mr-auto`} />} />
