  ...
  return (
    <>
        ...
        <AnimateOnScroll ref={sectionRef4} offset={20}>
            <div className="my-10">
                <FiftyPercentDefaultWrapper outlineText='Hello, Doctor!' title='Our Packages to Boost Your Robotics Practice' description="'We offer comprehensive solutions to help you capitalize on the financial benefits of robotic surgery." inlineClass='md:w-[70%]' textClass='px' />
