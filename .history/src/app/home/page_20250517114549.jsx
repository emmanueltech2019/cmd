  ...
  return (
    <>
        ...
        <AnimateOnScroll ref={sectionRef4} offset={20}>
            <div className="my-10">
                <FiftyPercentDefaultWrapper outlineText='Hello, Doctor!' title='Our Packages to Boost Your Robotics Practice' description="'We offer comprehensive solutions to help you capitalize on the financial benefits of robotic surgery." inlineClass='md:w-[70%]' textClass='px-5' />
        ...
        <AnimateOnScroll ref={sectionRef6} offset={20}>     
            <CardWrapper gridCol={`md:grid-cols-2`} className={`md:p-20 p-2 border-white border-2 rounded-3xl mt-20 mb-20 mx-auto w-full`} bg={`${secondCardBackground.src}`}> 
