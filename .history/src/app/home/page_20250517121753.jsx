                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-3">
                                ...
                                <p className="tmdext-lg  font-ligher">Effective landing page</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">3 audience campaigns</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">2 SEO key phrases</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">10 personalized contents</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">Digital reputation management</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">5 referral campaigns</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">40 key SEO phrases</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">20 personalized contents</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="tmdext-lg  font-ligher">Digital reputation management</p>
