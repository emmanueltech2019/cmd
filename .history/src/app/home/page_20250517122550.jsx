...
import medellinFadeCheck from '@/images/png/medellinFadeCheck.png'
...
const page = () => {
  ...
  return (
    <>
        <nav className={`fixed top-0 z-50 flex h-auto flex-col md:flex-row items-start md:items-center transition-rounded duration-500 ease-in-out justify-between mx-auto my-5 -translate-x-1/2 border-2 border-white left-1/2 md:w-web-navwidth w-[90%] bg-web-navwhite backdrop-blur-md p-web-nav-padding rounded-web-radius ${toggleNav ? 'rounded-xl' : 'rounded-web-radius'}`}>
        ...
        >
            <div className="md:mt-[19%] mt-[45%] w-[100%] md:w-[80%] mx-auto md:px-0 px-3 animate-translate">
                <h1 className="px-5 text-3xl text-center text-web-blue md:text-webhero-font md:leading-webhero-lineheight">Transform Your Surgical Practice! Maximize Profits with Robotic Surgery in Medellin</h1>
        ...
        <AnimateOnScroll ref={sectionRef3} offset={20}>
            <div className="flex items-center justify-center w-full my-5">
                <div className="w-full md:w-[50%]">
                    <FiftyPercentDefaultWrapper outlineText={`Get in touch`} title={`Contact Us`} description={`Fill out the form below and let's get started`} inlineClass='md:w-full' textClass={`px-8`} />
                    <div className="my-10">
                        <form action="" className='px-8 md:px-0'>
        ...
        <AnimateOnScroll ref={sectionRef4} offset={20}>
            <div className="my-10">
                ...
                <CardWrapper bg={`${secondCardBackground.src}`} className={`md:grid-cols-2 border-4 border-white rounded-3xl md:p-5 p-2  mx-auto`}>
        ...
        <AnimateOnScroll ref={sectionRef6} offset={20}>     
            <CardWrapper gridCol={`md:grid-cols-2`} className={`md:p-20 p-2 border-white border-2 rounded-3xl mt-20 mb-20 mx-auto w-[90%]`} bg={`${secondCardBackground.src}`}> 
                <div className="w-full">   
                    <Image className='w-full' src={medellinDoctor} width={1000} height={1000} alt='medellin doctor' />
                </div>
                <FiftyPercentDefaultWrapper textClass={`md:text-start md:px-5`} extraClass='mx-5 text-sm' className="flex flex-col items-center justify-start w-full mb-10 md:items-start md:w-full" outlineText={`Join the top 10`} title={`Increase Your Revenue and Reputation with Advanced Robotic Surgery`} description={`Are you looking to take your surgical practice to the next level and increase your revenue? Robotic surgery in Colombia is booming, and patients are actively seeking surgeons who offer this cutting-edge technology.`} infiniteSlider={<InfiniteSlider className={`md:w-[80%] mt-5 mr-auto`} />} />
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-sm md:text-lg font-ligher">Effective landing page</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">3 audience campaigns</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">2 SEO key phrases</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">10 personalized contents</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinFadeCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">Digital reputation management</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">5 referral campaigns</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">40 key SEO phrases</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">20 personalized contents</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Image src={medellinFadeCheck} alt='medellin check' width={100} height={100} className='w-5' />
                                <p className="text-sm md:text-lg font-ligher">Digital reputation management</p>
        ...
        <AnimateOnScroll ref={sectionRef9} offset={20}>    
            <div className="w-[90%] md:w-[80%] md:p-20 p-2 border-white border-2 rounded-3xl mt-20 mb-20 mx-auto" 
                style={{
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                    {accordionContent.map((content, index) => {
                        ...
                        >
                            <div className="flex items-start justify-between px-3 py-2 text-sm bg-white md:items-center md:text-xl text-web-blue rounded-xl">
                                <p className="text-lg md:pe-0 pe-5 md:text-xl">
                                    {content.header}
                                </p>
                            <Image
                                src={content.arrow}
                                ...
                                width={100}
                                height={100}
                                className={`md:w-[3%] w-[6%] transition-transform duration-300 ${
                                isOpen ? 'rotate-45' : ''
                                }`}
                            />
                            </div>
